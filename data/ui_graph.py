...
class Interaction(Data,Graph):
    def __init__(self, conf, training, test):
        ...
        self.ui_adj = self.__create_sparse_bipartite_adjacency() #(m+n)*(m+n)
        self.norm_adj = self.normalize_graph_mat(self.ui_adj)
        self.interaction_mat = self.__create_sparse_interaction_matrix() #m*n
        self.norm_inter = self.normalize_graph_mat(self.interaction_mat)
        # popularity_user = {}
        # for u in self.user:

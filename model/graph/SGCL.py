...
# Paper: Symmetric Graph Contrastive Learning against Noisy Views for Recommendation. TOIS'25
# https://github.com/user683/SGCL/tree/main
...
class SGL_Encoder(nn.Module):
    ...
    def scl_loss(self, out_1, out_2, lam, p, temperature):
        out_1, out_2 = nn.functional.normalize(out_1, dim=1), nn.functional.normalize(out_2, dim=1)
    ...
    def cal_scl_loss(self, idx, perturbed_mat1, perturbed_mat2):
        ...
        return self.scl_loss(view1, view2, 0.1, 0.01, self.temp)
...
labels = ['LastFM','Beauty', 'Douban', 'Yelp', 'Gowalla']
lightgcn_tpe = [0.62,2.95,5.34,24.61,14.75]
ltgnn_tpe = [1.09,3.16,10.42,30.78,16.30]
mixgcf_tpe = [0.67,2.73,5.29,22.84,14.16]
sgl_tpe = [1.38,4.67,12.64,55.91,29.15]
ff_tpe = [0.60,2.83,4.95,22.08,14.88]

lightgcn_e = [424,257,270,173,368]
ltgnn_e = [960,777,1081,1197,963]
mixgcf_e = [602,412,413,341,635]
sgl_e = [122,87,86,69,76]
ff_e = [114,71,76,61,69]

lightgcn_tt = [263,758,1442,4258,5427]
ltgnn_tt = [1046,2455,11264,36844,15693]
mixgcf_tt = [403,1125,2185,7788,8991]
sgl_tt = [168,406,1087,3858,2215]
ff_tt = [75,204,341,1368,1026]

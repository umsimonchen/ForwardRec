...
training_record_FF = []
for dataset in ['lastfm','beauty','douban_new','yelp2018','gowalla']:
...
training_record_SGL = []
for dataset in ['lastfm','beauty','douban','yelp2018','gowalla']:
...
line9 = ax[4].plot(np.arange(len(training_record_FF[4][0])-87), training_record_FF[4][0][87:], label='ForwardRec', linestyle='-.', linewidth=2, color=plt.cm.Set1(1))
line9_SGL = ax[4].plot(np.arange(len(training_record_FF[4][0])-87), training_record_SGL[4][0][:len(training_record_FF[4][0])-87], label='SGL', linestyle='-.', linewidth=2, color=plt.cm.Set1(4))
line9_LighGCN = ax[4].plot(np.arange(len(training_record_FF[4][0])-87), training_record_LightGCN[4][0][:len(training_record_FF[4][0])-87], label='LightGCN', linestyle='-.', linewidth=2, color=plt.cm.Set1(3))
line9_MixGCF = ax[4].plot(np.arange(len(training_record_FF[4][0])-87), training_record_MixGCF[4][0][:len(training_record_FF[4][0])-87], label='MixGCF', linestyle='-.', linewidth=2, color=plt.cm.Set1(2))
line9_LTGNN = ax[4].plot(np.arange(len(training_record_FF[4][0])-87), training_record_LTGNN[4][0][:len(training_record_FF[4][0])-87], label='LTGNN', linestyle='-.', linewidth=2, color=plt.cm.Set1(7))
#ax4 = ax[4].twinx()
...
ax[4].set_title('Gowalla', fontsize=30)
# #ax.set_xticks(x)
# #ax.set_xticklabels(labels)
